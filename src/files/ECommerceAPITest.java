...
public class ECommerceAPITest {
	...
	public static void main(String[] args) {
		...
		loginRequest.setUserEmail("saadmujawar1212@gmail.com");
		loginRequest.setUserPassword("Saad@007");
		...
		.param("productFor", "men").multiPart("productImage", new File("E:\\speed.png"));
		...
		String resonseAddOrder= createOrderReq.when().post("/api/ecom/order/create-order").then().log().all().extract().response().asString();
		System.out.println(resonseAddOrder);
